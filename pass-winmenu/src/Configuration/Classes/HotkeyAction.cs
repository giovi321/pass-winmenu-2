namespace PassWinmenu.Configuration
{
	public enum HotkeyAction
	{
		...
		ShowPassword, // Show all fields of a password file and copy a chosen one
		...
		ReencryptPasswordStore, // Re-encrypt all passwords in the store
		EnrollBiometrics, // Set up Windows Hello (fingerprint) unlock
